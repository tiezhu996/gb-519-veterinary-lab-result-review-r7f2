...
func handleError(c *gin.Context, err error) {
	...
	case errors.Is(err, repository.ErrAlreadyConfirmed):
		util.Fail(c, http.StatusConflict, "already_confirmed", "disposition was already confirmed")
	...
	case errors.Is(err, service.ErrInvalidTransition), errors.Is(err, service.ErrInvalidInput),
		...
		errors.Is(err, service.ErrCriticalGate), errors.Is(err, service.ErrDispositionState),
		errors.Is(err, service.ErrRunOperator), errors.Is(err, service.ErrAssayInvalid):
