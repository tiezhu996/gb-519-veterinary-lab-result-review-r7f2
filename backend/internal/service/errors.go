...
var (
	...
	ErrGateBlocked        = errors.New("critical result awaits disposition confirmation and cannot enter review")
	ErrDispositionClosed  = errors.New("critical disposition is no longer awaiting confirmation")
	ErrRunOperatorBlocked = errors.New("the assay run operator cannot confirm this disposition")
)
